...
\subsection{Classificação de series temporais com redes neurais}

Ler: Time Series Classification with Recurrent Neural Networks e Time Series Classification from Scratch with Deep Neural Networks: A Strong Baseline
